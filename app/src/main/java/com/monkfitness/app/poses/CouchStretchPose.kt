...
class CouchStretchPose : PoseBuilder {
    ...
    override fun build(context: PoseContext): SkeletonPose {
        ...
        val pelvisX = lerp(10f, -15f, context.progress)
        ...
        val leanAngle = lerp(0.2f, -0.05f, context.progress)
        ...
        // 2. Fixed Kinematics for Back Leg (Side B)
        val thighVecB = Vector3(kneeBX - pelvisX, kneeBY - pelvisY, 0f)
        val shinVecB = Vector3(0f, def.shinLength, 0f) // Shin strictly vertical against the box
        ...
        val targetAnkleF = Vector3(55f, 25f, -def.hipWidth)
        ...
        val worldFootF = Vector3(0f, -1f, 0f) // Front foot flat on floor
        ...
        val worldFootB = Vector3(0f, 1f, 0f) // Back foot points strictly up the wall
