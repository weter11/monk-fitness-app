...
class WidePushUpPose : BasePushUpPose() {
    private val poleFront = Vector3(0.2f, 0.8f, -2.0f)
    private val poleBack = Vector3(0.2f, 0.8f, 2.0f)
    private val handDirFront = Vector3(-1f, 0f, -0.4f).normalize()
    private val handDirBack = Vector3(-1f, 0f, 0.4f).normalize()
