...
class BandPullApartsPose : PoseBuilder {
    ...
    override fun build(context: PoseContext): SkeletonPose {
        ...
        // 3. Arm IK (scapular pull-aparts)
        val shoulderY = pelvisY + def.torsoLength
        val targetHandA = Vector3(lerp(130f, 0f, factor), shoulderY, lerp(-15f, -def.shoulderWidth - 90f, factor))
        val targetHandP = Vector3(lerp(130f, 0f, factor), shoulderY, lerp(15f, def.shoulderWidth + 90f, factor))
