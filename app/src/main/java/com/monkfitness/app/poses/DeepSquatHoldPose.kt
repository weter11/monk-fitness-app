...
class DeepSquatHoldPose : PoseBuilder {
    ...
    override fun build(context: PoseContext): SkeletonPose {
        ...
        val targetAnkleF = Vector3(0f, 25f, -def.hipWidth * 1.5f)
        val targetAnkleB = Vector3(0f, 25f, def.hipWidth * 1.5f)

        val legFIK = solveIK(hipF!!.worldPosition, targetAnkleF, def.thighLength, def.shinLength, Vector3(1f, 0f, -0.4f), def.legIKConstraint, legFBuffer)
        val legBIK = solveIK(hipB!!.worldPosition, targetAnkleB, def.thighLength, def.shinLength, Vector3(1f, 0f, 0.4f), def.legIKConstraint, legBBuffer)
        ...
        val armAIK = solveIK(shoulderA!!.worldPosition, Vector3(handTargetX, handTargetY, -2f), def.upperArmLength, def.forearmLength, Vector3(0f, -0.5f, -1f), def.armIKConstraint, armABuffer)
        val armPIK = solveIK(shoulderP!!.worldPosition, Vector3(handTargetX, handTargetY, 2f), def.upperArmLength, def.forearmLength, Vector3(0f, -0.5f, 1f), def.armIKConstraint, armPBuffer)
