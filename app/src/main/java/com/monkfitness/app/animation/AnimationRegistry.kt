...
object AnimationRegistry {
    ...
    init {
        ...
        register("wall_slide_standard", WallSlidesPose())
        ...
        register("lunge_walking", WalkingLungePose())
        register("lunge_split_squat", StaticSplitSquatPose())
        register("lunge_bulgarian", BulgarianSplitSquatPose())
        register("lunge_curtsy", CurtsyLungePose())
        register("step_up_standard", StepUpPose())
        register("step_up_high", HighStepUpPose())
