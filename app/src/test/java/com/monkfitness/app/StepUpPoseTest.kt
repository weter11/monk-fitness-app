...
import com.monkfitness.app.poses.StepUpPose
import org.junit.Assert.*
import org.junit.Test
import kotlin.math.*

class StepUpPoseTest {
    ...
    @Test
    fun testStepUpPoseMeetsAllBiomechanicalRequirements() {
        val totalFrames = 90
        val dt = 0.033f
        ...
        // Keep track of maximum values across the sequence to verify limits
        ...
        for (i in 0..totalFrames) {
            ...
            val report = validator.validate(
                pose = pose,
                definition = def,
                environment = stepUpPose.metadata.environment,
                camera = camera,
                width = 1000f,
                height = 1000f,
