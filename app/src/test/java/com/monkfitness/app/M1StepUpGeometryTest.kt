...
class M1StepUpGeometryTest {
    ...
    companion object {
        ...
        * the re-baseline (this live run measured `3907844211770727281`). Attribution is direct, not
        * inferred
        ...
        * other `50` classes byte-identical. B1's own regression is `DiamondPushUpElbowClearanceTest`.
         ...
         * previous value `-2764093049021801384` before the re-baseline (this live run measured `-2141320411591611242`). Attribution is direct,
         ...
         * layer is `14`). Observed RED on the previous value `-2141320411591611242` before the
         * re-baseline (this live run measured `-3183663957542651220`). Attribution is direct, not
         ...
         * projection. Observed RED on the previous value `-3183663957542651220` before the re-baseline (this live run
         * measured `-3833979825676675382`). Attribution is direct, not inferred: a whole-corpus dump (`51` classes ×
         ...
         * GREEN on the pre-baseline value (measured in the same session).
          ...
          * (`DeepSquatHoldPose`, `JumpSquatPose`). Observed RED on the pre-baseline value `-3833979825676675382`
          * before the re-baseline (this live run measured `-7706271665562987902` below). Attribution is direct, not
          * inferred
          ...
          * chains' reachable annulus and are now projected onto it (R2/R4). Observed RED on the pre-baseline value `-7706271665562987902` before the re-baseline
          * (this live run measured `-2576201625353859114`). Attribution is direct, not inferred: the whole-corpus A/B (`51`
          ...
          * are now projected onto it (R2/R4). Observed RED on the pre-baseline value `-2576201625353859114` before this re-baseline
          * (the live run measured `7239245416308699703`). Attribution is direct, not inferred: the whole-corpus A/B (`51` classes ×
         ...
         * drift. Pre-rebaseline measurement: `6372502693407939644`.
                  *
         ...
         * measurement: `3957245745717767502`.
         *
         ...
         * membership, not geometry drift. Pre-rebaseline measurement: `6015554476292045311`.
         ...
         * byte-identical. Pre-rebaseline measurement: `-6703469261057718571`.
         *
         ...
         * byte-identical. Pre-rebaseline measurement: `-5730594616648658542`.
         ...
         * Pre-rebaseline measurement: `-8334287398377476430`.
*/
        const val UNAFFECTED_CORPUS_DIGEST = 1204836579372112615L
    }
}
