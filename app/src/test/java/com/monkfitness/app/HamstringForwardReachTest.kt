...
class HamstringForwardReachTest {
    ...
    companion object {
        ...
        * other `50` classes byte-identical. B1's own regression is `DiamondPushUpElbowClearanceTest`.
         ...
         * drift. Pre-rebaseline measurement: `-6285256207466094342`.
                  *
         ...
         * measurement: `-3634956584451138036`.
         *
         ...
         * membership, not geometry drift. Pre-rebaseline measurement: `7355761803469032637`.
         ...
         * byte-identical. Pre-rebaseline measurement: `-7729117442052532845`.
*/
        const val UNAFFECTED_CORPUS_DIGEST = -247797092231647152L
    }
}
