...
class ShoulderCarsTest {

    @Test
    fun testShoulderCarsAnimationMeetsRequirements() {
        val poseBuilder = ShoulderCarsPose()
        ...
        println("=== SHOULDER CARs VALIDATION REPORT ===")
        ...
        assertTrue("Shoulder CARs animation score must be >= 95, actual: ${reviewReport.score}", reviewReport.score >= 95)
    }
}
