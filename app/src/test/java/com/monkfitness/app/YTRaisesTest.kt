...
class YTRaisesTest {
    ...
    @Test
    fun testYTRaisesAnimationMeetsRequirements() {
        val poseBuilder = YTRaisesPose()
        ...
        val validatorConfig = ValidatorConfig(
            ...
            expectedSupportJoints = setOf(Joint.PELVIS, Joint.CHEST, Joint.KNEE_F, Joint.KNEE_B, Joint.ANKLE_F, Joint.ANKLE_B)
        )
        ...
        println("=== Y-T RAISES VALIDATION REPORT ===")
        ...
        assertTrue("Y-T Raises animation score must be >= 95, actual: ${reviewReport.score}", reviewReport.score >= 95)
    }
}
