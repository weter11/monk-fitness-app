...
class ReverseSnowAngelPoseTest {
    ...
    @Test
    fun testReverseSnowAngelPoseMeetsAllBiomechanicalRequirements() {
        val totalFrames = 90
        val dt = 0.033f
        ...
        for (i in 0..totalFrames) {
            ...
            val report = validator.validate(
                pose = pose,
                definition = def,
                environment = angelPose.metadata.environment,
                camera = camera,
                width = 1000f,
                height = 1000f,
        ...
        println("Validated Prone Reverse Snow Angels sequence successfully! Exercise score: ${reviewReport.score}")
