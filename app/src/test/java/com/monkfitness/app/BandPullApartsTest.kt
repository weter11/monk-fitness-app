...
import com.monkfitness.app.poses.BandPullApartsPose
import org.junit.Assert.*
import org.junit.Test

class BandPullApartsTest {

    @Test
    fun testBandPullApartsAnimationMeetsRequirements() {
        val poseBuilder = BandPullApartsPose()
        ...
        val validatorConfig = ValidatorConfig(
            ...
            expectedSupportJoints = setOf(Joint.HEEL_F, Joint.HEEL_B, Joint.ANKLE_F, Joint.ANKLE_B)
        )
        ...
        println("=== BAND PULL-APARTS VALIDATION REPORT ===")
        ...
        assertTrue("Band Pull-Aparts animation score must be >= 95, actual: ${reviewReport.score}", reviewReport.score >= 95)
    }
}
